...
public class PreloadWelcomePageCommand implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(session.getAttribute("facultiesList") == null && session.getAttribute("description") == null) {
            System.out.println("Attributes update");
            ...
            session.setAttribute("facultiesList", faculties);
